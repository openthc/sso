...
INSERT INTO auth_company_contact (company_id, contact_id) VALUES ('010PENTHCXC0MPANY00000R00T', '018NY6XC00C0NTACT000000000');
...
INSERT INTO auth_service (company_id, name, code, hash) VALUES ('010PENTHCXC0MPANY00000R00T', 'sso.openthc.local', 'sso.openthc.local', 'sso.openthc.local-secret');
INSERT INTO auth_service (company_id, name, code, hash) VALUES ('010PENTHCXC0MPANY00000R00T', 'cre.openthc.local', 'cre.openthc.local', 'cre.openthc.local-secret');
INSERT INTO auth_service (company_id, name, code, hash) VALUES ('010PENTHCXC0MPANY00000R00T', 'app.openthc.local', 'app.openthc.local', 'app.openthc.local-secret');
INSERT INTO auth_service (company_id, name, code, hash) VALUES ('010PENTHCXC0MPANY00000R00T', 'lab.openthc.local', 'lab.openthc.local', 'lab.openthc.local-secret');
INSERT INTO auth_service (company_id, name, code, hash) VALUES ('010PENTHCXC0MPANY00000R00T', 'pos.openthc.local', 'pos.openthc.local', 'pos.openthc.local-secret');
